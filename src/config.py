...
# ── 분기 흐름(2025) 분석 ──────────────────────────────────────
# 누적(YTD) 기준으로 연중 흐름을 추적한다.
#   thstrm_amount=당기(3개월), thstrm_add_amount=누적(YTD)
# 보고서: 1Q(11013)·상반기(11012)·3분기(11014)는 누적, 연간(11011)은 그 자체가 누적.
QUARTER_YEARS = [2024, 2025]
QUARTERS = [("11013", "1Q"), ("11012", "상반기"), ("11014", "3분기"), ("11011", "연간")]
RAW_Q = DATA / "raw_q"
